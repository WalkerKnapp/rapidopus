...
jlong Java_com_walker_rapidopus_OpusDecoder_decoderCreate(JNIEnv *env, jclass jClazz, jint jSampleRate, jint jChannels) {
    int err = OPUS_OK;
...
void Java_com_walker_rapidopus_OpusDecoder_decoderDestroy(JNIEnv *env, jclass jClazz, jlong pDecoder) {
    opus_decoder_destroy(reinterpret_cast<OpusDecoder *>(pDecoder));
}

jint Java_com_walker_rapidopus_OpusDecoder_decode__J_3BLjava_nio_ByteBuffer_2II
...
jint Java_com_walker_rapidopus_OpusDecoder_decode__JLjava_nio_ByteBuffer_2Ljava_nio_ByteBuffer_2II
...
jint Java_com_walker_rapidopus_OpusDecoder_decodeFloat__J_3BLjava_nio_ByteBuffer_2II
...
jint Java_com_walker_rapidopus_OpusDecoder_decodeFloat__JLjava_nio_ByteBuffer_2Ljava_nio_ByteBuffer_2II
    (JNIEnv *env, jclass jClazz, jlong pDecoder, jobject jInputBuffer, jobject jOutputBuffer, jint jFrameSize, jint jDecodeFec) {
...
jint Java_com_walker_rapidopus_OpusDecoder_decoderGetNbSamples__J_3B(JNIEnv *env, jclass jClazz, jlong pDecoder, jbyteArray jInputData) {
    jboolean isCopy = JNI_FALSE;
    int inSize = env->GetArrayLength(jInputData);
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_decoderGetNbSamples__JLjava_nio_ByteBuffer_2(JNIEnv *env, jclass jClazz, jlong pDecoder, jobject jInputBuffer) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));
    int inSize = env->GetDirectBufferCapacity(jInputBuffer);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetBandwidth___3B(JNIEnv *env, jclass jClazz, jbyteArray jInputData) {
    jboolean isCopy = JNI_FALSE;
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetBandwidth__Ljava_nio_ByteBuffer_2(JNIEnv *env, jclass jClazz, jobject jInputBuffer) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));

    return opus_packet_get_bandwidth(inData);
}

jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbChannels___3B(JNIEnv *env, jclass jClazz, jbyteArray jInputData) {
    jboolean isCopy = JNI_FALSE;
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbChannels__Ljava_nio_ByteBuffer_2(JNIEnv *env, jclass jClazz, jobject jInputBuffer) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));

    return opus_packet_get_nb_channels(inData);
}

jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbFrames___3B(JNIEnv *env, jclass jClazz, jbyteArray jInputData) {
    jboolean isCopy = JNI_FALSE;
    int inSize = env->GetArrayLength(jInputData);
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbFrames__Ljava_nio_ByteBuffer_2(JNIEnv *env, jclass jClazz, jobject jInputBuffer) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));
    int inSize = env->GetDirectBufferCapacity(jInputBuffer);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbSamples___3BI(JNIEnv *env, jclass jClazz, jbyteArray jInputData, jint jSampleRate) {
    jboolean isCopy = JNI_FALSE;
    int inSize = env->GetArrayLength(jInputData);
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetNbSamples__Ljava_nio_ByteBuffer_2I(JNIEnv *env, jclass jClazz, jobject jInputBuffer, jint jSampleRate) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));
    int inSize = env->GetDirectBufferCapacity(jInputBuffer);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetSamplesPerFrame___3BI(JNIEnv *env, jclass jClazz, jbyteArray jInputData, jint jSampleRate) {
    jboolean isCopy = JNI_FALSE;
    jbyte *inData = env->GetByteArrayElements(jInputData, &isCopy);
...
jint Java_com_walker_rapidopus_OpusDecoder_packetGetSamplesPerFrame__Ljava_nio_ByteBuffer_2I(JNIEnv *env, jclass jClazz, jobject jInputBuffer, jint jSampleRate) {
    auto *inData = reinterpret_cast<unsigned char *>(env->GetDirectBufferAddress(jInputBuffer));
    int inSize = env->GetDirectBufferCapacity(jInputBuffer);
...
void Java_com_walker_rapidopus_OpusDecoder_nPcmSoftClip___3FII_3F(JNIEnv *env, jclass jClazz, jfloatArray jPcmData, jint jFrameSize, jint jChannels, jfloatArray jMem) {
    jboolean isCopy = JNI_FALSE;
...
void Java_com_walker_rapidopus_OpusDecoder_nPcmSoftClip__Ljava_nio_ByteBuffer_2II_3F
...
void Java_com_walker_rapidopus_OpusDecoder_nPcmSoftClip___3FIILjava_nio_ByteBuffer_2
...
void Java_com_walker_rapidopus_OpusDecoder_nPcmSoftClip__Ljava_nio_ByteBuffer_2IILjava_nio_ByteBuffer_2
