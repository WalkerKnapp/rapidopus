...
jlong Java_com_walker_rapidopus_OpusEncoder_encoderCreate(JNIEnv *env, jclass jClazz, jint jSampleRate, jint jChannels, jint jApplicationMode) {
    int error = OPUS_OK;
...
void Java_com_walker_rapidopus_OpusEncoder_encoderDestroy(JNIEnv *env, jclass jClazz, jlong pEncoder) {
    opus_encoder_destroy(reinterpret_cast<OpusEncoder *>(pEncoder));
}

jint Java_com_walker_rapidopus_OpusEncoder_encode__J_3SILjava_nio_ByteBuffer_2
...
jint Java_com_walker_rapidopus_OpusEncoder_encode__JLjava_nio_ByteBuffer_2ILjava_nio_ByteBuffer_2
...
jint Java_com_walker_rapidopus_OpusEncoder_encodeFloat__J_3FILjava_nio_ByteBuffer_2
...
jint Java_com_walker_rapidopus_OpusEncoder_encodeFloat__JLjava_nio_ByteBuffer_2ILjava_nio_ByteBuffer_2
    (JNIEnv *env, jclass jClazz, jlong pEncoder, jobject jInputBuffer, jint jFrameSize, jobject jOutputBuffer) {
